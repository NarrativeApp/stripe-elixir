defmodule Stripe.SubscriptionItemTest do
  ...
  alias Stripe.{Customer, InvalidRequestError, Plan, Subscription, SubscriptionItem, Token}
  ...
  test "create/update/delete a subscription_item", %{subscription: subscription} do
    ...
    assert {:ok, %{"quantity" => 2}} =
             SubscriptionItem.update(subscription_item["id"], quantity: 2)
